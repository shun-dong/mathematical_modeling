...
%     k-Wave. The grid structures are indexed as: (x, 1) in 1D; (x, y) in
...
%     .total_grid_points - total number of grid points (equal to Nx*Ny*Nz)
%     .highest_prime_factors - 3 x 1 vector of the highest prime factor in
%                       each direction 
%
...
% kspaceSecondOrder, pstdElastic2D, pstdElastic2D
...
classdef kWaveGrid < handle
    ...
    methods
        ...
        function highest_prime_factors = get.highest_prime_factors(obj)
