function [Factors,it,err,corcondia]=nwayparafac(X,Fac,Options,const,OldLoad,FixMode,Weights);

% PARAFAC multiway parafac model
%
% Note this file is an identical copy of parafac, from the nway toolbox
% (nway320) renamed to nwayparafac to avoid clashes with other versions 
% (e.g. in the Eigenvector Inc. PLS_toolbox).
%
% See also:
