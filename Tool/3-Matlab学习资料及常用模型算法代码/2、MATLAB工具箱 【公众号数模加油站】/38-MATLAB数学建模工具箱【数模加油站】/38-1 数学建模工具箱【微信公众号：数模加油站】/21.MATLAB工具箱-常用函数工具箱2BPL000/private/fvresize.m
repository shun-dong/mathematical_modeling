...
if nargin == 0
	...
	% first resize the underlying frame:
	set(ud.ht.frame1,'position',[0 0 sz.bw+6*sz.ffs fp(4)-sz.ih])
   ...
   fvresize(1,fig)
    ...
    fp = get(fig,'position');
    ud = get(fig,'userdata');
    ax_panel = [ud.resize.leftwidth 0 ...
          fp(3)-ud.resize.leftwidth-(ud.sz.rw+10)*ud.prefs.tool.ruler ...
          fp(4)-ud.resize.topheight];
