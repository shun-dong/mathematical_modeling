...
case 'action'
    ...
    popupString = {'filter - Transposed Direct Form II' ...
                   'filtfilt - Zero phase IIR'};
    isFIR = (length(f.tf.den)==1);
    if isFIR
        popupString = {popupString{:} 'fftfilt - FFT based FIR'};
    end
    ...
    defaultLabel = uniqueDefaultLabel(labelList,defaultLabel);
