...
%
%   See also CHEBY1, BUTTORD, ELLIPORD, CHEB2ORD.
...
%   $Revision: 1.10 $  $Date: 1997/11/26 20:13:22 $
...
elseif ftype == 3	% stop
	fo = foptions;
	wp1 = fmin('bscost',WPA(1),WSA(1)-1e-12,fo,1,...
                      WPA,WSA,rs,rp,'cheby');
	WPA(1) = wp1;
	wp2 = fmin('bscost',WSA(2)+1e-12,WPA(2),fo,2,...
                      WPA,WSA,rs,rp,'cheby');
	WPA(2) = wp2;
...
if strcmp(opt,'z')	% digital
	wn=(2/pi)*atan(WPA);  % bilinear transform
else
	wn=WPA;
end
