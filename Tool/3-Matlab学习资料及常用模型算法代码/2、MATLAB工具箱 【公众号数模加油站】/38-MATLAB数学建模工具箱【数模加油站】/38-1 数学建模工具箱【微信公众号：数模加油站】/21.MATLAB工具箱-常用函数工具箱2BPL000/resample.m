...
%   is designed using FIR1 with a Kaiser window.  RESAMPLE provides an 
%   easy-to-use alternative to UPFIRDN, which does not require you to supply
%   a filter or compensate for the signal delay introduced by filtering.
%
...
%   $Revision: 1.19 $  $Date: 1997/11/26 20:12:59 $
