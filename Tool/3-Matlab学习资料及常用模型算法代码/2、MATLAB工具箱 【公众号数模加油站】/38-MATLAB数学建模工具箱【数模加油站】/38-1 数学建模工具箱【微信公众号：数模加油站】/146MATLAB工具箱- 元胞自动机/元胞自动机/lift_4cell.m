...
hf=figure('Position',[350,100,600,400],'Resize','off','menubar','none', ...
    'Name','Life: Conway''s Game of Life: 4 cells', ...
    'NumberTitle','off');
...
% cells(2,[3 4])=1; cells(3,[3,4])=1; 
% cells(7,[2 3 4 5])=1;  
% cells(11,3)=1; cells(12,[3 4])=1; cells(13,4)=1;
% cells(16,3)=1; cells(17,[3 4 5])=1;
% 
% cells(22,4)=1; cells(23,[3 4 5])=1;

cells(7,8)=1; cells(8,[7 8 9])=1;

cells(2,14)=1; cells(3, 15)=1; cells(4, [13 14 15])=1;
