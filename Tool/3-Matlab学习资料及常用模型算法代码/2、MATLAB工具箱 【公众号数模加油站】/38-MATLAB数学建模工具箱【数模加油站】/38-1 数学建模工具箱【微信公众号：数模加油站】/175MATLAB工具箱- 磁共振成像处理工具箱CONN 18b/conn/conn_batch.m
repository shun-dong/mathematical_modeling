...
%                       Setup.unwarp_functionals, Setup.fmap_functionals, Setup.coregsource_functionals, Setup.spmfiles, 
...
%                        'functional_masked_smooth'              : functional spatial masked-smoothing (spatial convolution with Gaussian kernel 
...
%                        'surface_resample'                      : resample functional data at the location of FreeSurfer subject-specific 
%                                                                   structural cortical surface
%                        'surface_smooth'                        : functional spatial diffusion of surface data 
...
if isfield(batch,'New'), % obsolete functionality / for backwards compatibility only
    ...
    conn_disp('This option is no longer supported and may become obsolete in future releases. Please transition your BATCH.New scripts to use BATCH.Setup.preprocessing instead'); 
...
if isfield(batch,'QA'),
    ...
    if isfield(batch,'parallel')&&isfield(batch.parallel,'N')&&batch.parallel.N>0,
        ...
        PAR_ARG{end+1}={[],qafolder,procedures,SUBJECTS,validrois,validsets,nl2covariates,nl1contrasts};
    else
        conn_process('qaplots',qafolder,procedures,SUBJECTS,validrois,validsets,nl2covariates,nl1contrasts);
        CONN_x.gui=1;
    end
end
