...
%     if there is a pending job, cancels all unfinished nodes and finish job
%
%   conn_jobmanager delete;
%     if there is a pending job, stop all nodes and delete job
%
...
varargout={};
qoptions={'all','report','restartstopped','finish','cancel','delete','ispending'};
