...
if nargin<1 || ischar(varargin{1}),
    ...
    if h.isfiles
        ...
        if ~isempty(params.buttonhelp), h.strbuttonhelp=params.buttonhelp; 
        else h.strbuttonhelp=[h.strbutton,' selected folder'];
        end
...
dlg.m11=uicontrol('style','pushbutton','units','norm','position',[.55,.04,.2,.1],'string','Import','callback','uiresume(gcbf)','fontsize',9+font_offset);
