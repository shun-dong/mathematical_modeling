...
%   - now the swapping of subtrees is made in only one step
%     (substituted lines 47 by line 46);
%   - field 'nodes' of new individual is filled
%     using additional information of field 'tree'.
...
newtree=maketree(state.iniclevel,state.functions,state.arity,0,state.depthnodes,x-1);
