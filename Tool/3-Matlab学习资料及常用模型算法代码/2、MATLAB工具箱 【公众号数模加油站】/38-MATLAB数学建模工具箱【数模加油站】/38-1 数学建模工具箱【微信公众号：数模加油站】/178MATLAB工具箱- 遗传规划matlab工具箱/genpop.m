...
[pop,state.lastid]=initpop(n,state.lastid,params.inicmaxlevel,state.functions,state.arity,params.initpoptype,state.depthnodes);
...
% now measure fitness on the individuals with empty fitness:
