...
%
%   Copyright (C) 2003-2004 Sara Silva (sara@itqb.unl.pt)
%   This file is part of the GPLAB Toolbox
%
%   Modified in August 2004:
%   - obsolete use of 'break' has been replaced by 'return'.
...
[ans,indresult]=calcfitness(state.bestsofar.str,params,data,state);
...
for i=1:size(params.hits,1)
   ...
   f=(indresult>=dataresultminus & indresult<=dataresultplus);
