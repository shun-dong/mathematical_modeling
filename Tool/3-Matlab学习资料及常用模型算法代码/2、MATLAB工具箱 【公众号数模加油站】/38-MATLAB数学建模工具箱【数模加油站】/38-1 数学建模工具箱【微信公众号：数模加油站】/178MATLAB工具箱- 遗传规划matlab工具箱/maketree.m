...
%   - now includes additional fields of tree (and each subtree):
%     'nodes' - the number of nodes if the tree;
%     'nodeid' - the id of the root node of the tree;
%     'maxid' - the maximum id of any node of the tree.
