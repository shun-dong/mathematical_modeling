...
% |wfilters| function are associated with an orthogonal or biorthogonal
% wavelet. To be an orthogonal or biorthogonal wavelet, several properties
% must hold. Yet, even if the created wavelet does not satify these
% properties, all the discrete and continuous analysis functions and the
% corresponding GUI tools, can also operate on the new wavelet. But
% reconstruction will not be perfect and therefore *x* will not be equal to
% *A2 + D2 + D1*.
