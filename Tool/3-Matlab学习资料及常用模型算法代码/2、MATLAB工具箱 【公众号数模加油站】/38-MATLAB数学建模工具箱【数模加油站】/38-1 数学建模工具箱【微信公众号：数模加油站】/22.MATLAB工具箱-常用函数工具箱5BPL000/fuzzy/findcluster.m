...
% FINDCLUSTER  is a cluster interface.
%   The FINDCLUSTER let you use two clustering algorithms interactively.
%   It is containts subtractive clustering and fuzzy c-means clustering.
...
%   $Revision: 1.6 $  $Date: 1997/12/01 21:44:52 $
...
case 'start',
   ...
   if strcmp(stopflag, 'Stop')
     ...
     if n==1
      ...
      [center, sigmas]=subclust(param.data, radioList, [],...
                                [str2num(squafactor), str2num(acceptfact), str2num(rejectfact), 0]);
   ...
   %=========fcm=============
      ...
      options=[str2num(get(expoHndl, 'String')), str2num(get(maxiHndl, 'String')),...
              str2num(get(miniHndl, 'String')), 0];
      cluster_n=str2num(get(paramHndl, 'String'));
