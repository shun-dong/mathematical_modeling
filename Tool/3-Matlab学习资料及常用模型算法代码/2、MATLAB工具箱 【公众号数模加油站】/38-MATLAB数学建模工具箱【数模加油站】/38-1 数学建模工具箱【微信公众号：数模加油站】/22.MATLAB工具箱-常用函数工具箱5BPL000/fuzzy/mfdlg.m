function handle=mfdlg(action,fis,varType,varIndex)
%MFDLG Create dialog for adding membership functions.
...
%   Kelly Liu 7-10-96, Ned Gulley, 9-15-94
%   Copyright (c) 1994-98 by The MathWorks, Inc.
%   $Revision: 1.14 $  $Date: 1997/12/01 21:45:06 $
...
elseif strcmp(action,'#okay'),
    ...
    if strcmp(fisType,'sugeno') & strcmp(varType,'output'),
        ...
        if mfNum==1,
            mfParams=mf2mf([varRange(1) mean(varRange) varRange(2)],'trimf',mfType);
            mfName='mf1';
            ...
            for count=1:mfNum,
                ...
                a=b-halfWidth;
                c=b+halfWidth;
                mfParams=mf2mf([a b c],'trimf',mfType);
                mfName=['mf' num2str(count)];
                fis=addmf(fis,varType,varIndex,mfName,mfType,mfParams);
            end
        end
