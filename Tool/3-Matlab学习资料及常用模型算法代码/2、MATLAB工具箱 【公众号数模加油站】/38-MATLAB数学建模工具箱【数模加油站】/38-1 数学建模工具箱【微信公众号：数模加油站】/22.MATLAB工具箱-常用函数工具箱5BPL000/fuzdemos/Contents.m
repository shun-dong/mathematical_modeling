...
%   slcp1      - Inv. pendulum with varying pole length (SIMULINK only)
%   slcpp1     - Double inv. pendulum with varying pole length (SIMULINK only)
...
%   $Revision: 1.5 $  $Date: 1997/12/01 21:43:59 $
